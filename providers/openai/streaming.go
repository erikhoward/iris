...
func (p *OpenAI) doStreamChat(ctx context.Context, req *core.ChatRequest) (*core.ChatStream, error) {
	// Build OpenAI request with stream=true
...
func (p *OpenAI) processSSEStream(
	ctx context.Context,
	body io.ReadCloser,
